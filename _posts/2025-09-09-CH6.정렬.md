...
![alt text](../assets/img_20250915/image.png)
...
![alt text](../assets/img_20250915/image-1.png)
...
- 퀵정렬: 기준을 설정 -> 다음 큰 수와 작은 수를 교환한 후 리스트를 반으로 나누는 방식.
    ...
    - 호어 분할 방식
        ...
        ![alt text](../assets/img_20250915/image-2.png)
        ![alt text](../assets/img_20250915/image-3.png)
        ![alt text](../assets/img_20250915/image-4.png)
        ![alt text](../assets/img_20250915/image-5.png)
...
![alt text](../assets/img_20250915/image-6.png)
![alt text](../assets/img_20250915/image-7.png)
![alt text](../assets/img_20250915/image-8.png)
![alt text](../assets/img_20250915/image-9.png)
![alt text](../assets/img_20250915/image-10.png)

4. 결과를 출력할때는 리스트의 첫 번째 데이터부터 하나씩 그 값만큼 반복하여 인덱스 출력.

![alt text](../assets/img_20250915/image-11.png)
